...
library VecLib {
    ...
    function get(UintVec memory self, uint256 index) internal pure returns (uint256 value) {
    ...
    // function contains(UintVec memory self, uint value) internal pure returns (bool) {
